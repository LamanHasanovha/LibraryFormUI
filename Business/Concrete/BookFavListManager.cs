...
{
    public class BookFavListManager : ManagerBaseRepository<BookFavList>, IBookFavListService
    {
        public BookFavListManager(HttpClient client, string baseAddress, UserForLoginModel userForLoginModel) : base(client, baseAddress, userForLoginModel)
        {
        }
