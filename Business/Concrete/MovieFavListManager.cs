...
{
    public class MovieFavListManager : ManagerBaseRepository<MovieFavList>, IMovieFavListService
    {
        public MovieFavListManager(HttpClient client, string baseAddress, UserForLoginModel userForLoginModel) : base(client, baseAddress, userForLoginModel)
        {
        }
