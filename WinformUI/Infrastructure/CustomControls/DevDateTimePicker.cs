...
{
    public class DevDateTimePicker : DateTimePicker
    {
        //Fields
        //-> Appearance
        ...
        private Image calendarIcon = WinformUI.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = WinformUI.Properties.Resources.calendarDark;
                else calendarIcon = WinformUI.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
