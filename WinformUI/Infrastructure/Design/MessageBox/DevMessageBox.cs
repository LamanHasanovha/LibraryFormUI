        ...
        private void SetIcon(MessageBoxIcon icon)
        {
            switch (icon)
            {
                case MessageBoxIcon.Error:
                    this.pictureBoxIcon.Image = WinformUI.Properties.Resources.error;
                    //PrimaryColor = Color.FromArgb(224, 79, 95);
                    this.btnClose.FlatAppearance.MouseOverBackColor = Color.Crimson;
                    break;
                case MessageBoxIcon.Information:
                    this.pictureBoxIcon.Image = WinformUI.Properties.Resources.information;
                    //PrimaryColor = Color.FromArgb(38, 191, 166);
                    break;
                case MessageBoxIcon.Question:
                    this.pictureBoxIcon.Image = WinformUI.Properties.Resources.question;
                    //PrimaryColor = Color.FromArgb(10, 119, 232);
                    break;
                case MessageBoxIcon.Exclamation:
                    this.pictureBoxIcon.Image = WinformUI.Properties.Resources.exclamation;
                    //PrimaryColor = Color.FromArgb(32, 30, 45);
                    break;
                case MessageBoxIcon.None:
                    this.pictureBoxIcon.Image = WinformUI.Properties.Resources.chat;
